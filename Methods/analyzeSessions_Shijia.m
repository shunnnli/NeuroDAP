...
% Figure set 6: for catch trials
analysisEvents_6 = {rewarded_normal4_rewardTime,rewarded_catch2_rewardTime};
eventTrialNum_6 = {findTrials(rewarded_normal4_rewardTime,trials),...
                 findTrials(rewarded_catch2_rewardTime,trials)};
analysisLabels_6 = {'Normal 4','Catch 2'};
taskLegend_6 = getLegend(analysisEvents_6,analysisLabels_6);

% to-do: concatenate analysis events
analysisEvents = {analysisEvents_1 analysisEvents_2 analysisEvents_3 analysisEvents_4 analysisEvents_5 analysisEvents_6};
analysisLabels = {}; 
eventTrialNum = {};
...
%         initializeFig(.5,.5); tiledlayout('flow');
        initializeFig(.5,1); tiledlayout(6,2);
        ...
        % Figure set 6: for catch trial solenoid onset 
        nexttile
        [~,~] = plotTraces(rewarded_normal4_rewardTime,timeRange,signal,bluePurpleRed(1,:),params,...
                                signalFs=finalFs,...
                                signalSystem=system,eventSystem=params.session.baselineSystem);
        [~,~] = plotTraces(rewarded_catch2_rewardTime,timeRange,signal,bluePurpleRed(500,:),params,...
                        signalFs=finalFs,...
                        signalSystem=system,eventSystem=params.session.baselineSystem);
        ...
        plotLicks(rewarded_catch2_rewardTime,timeRange,options.lick_binSize,bluePurpleRed(500,:),[],labjack.lick,params);
