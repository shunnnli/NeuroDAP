function peakData = scriptPerformAnalysisRandomSearch(data, baselineSD, pulseTime, responseSign)
    ...
    if isempty(peakData.heightPulsePeak)
        
        peakData.heightPulsePeak = nan;
        peakData.timePulsePeak = nan;
        
    end
    
    if isempty(peakData.heightControlPeak)

        peakData.heightControlPeak = nan;
