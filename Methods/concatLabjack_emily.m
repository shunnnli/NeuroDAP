...
%%% 12/16/2025 - NOT CURRENTLY IN USE - USING concatLabjack_WAB344a INSTEAD
%%% THIS VERSION DOES NOT SAVE BEHAVIOR DATA
...
arguments
    ...
    options.recordBehavior logical = true
...
if ~isequal(labjack.record,options.record) %|| sum(labjack.record == options.record) ~= 3 %edited by Emily 12/13/25 to fix error
