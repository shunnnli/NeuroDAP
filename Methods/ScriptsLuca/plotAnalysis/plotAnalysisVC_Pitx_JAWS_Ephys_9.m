...
experimentName = 'Pitx_JAWS_Ephys_9_VC';
...
selectedRunGroups = find(strcmp(runGroupsParametersTable.activeChannels,'ao0, ao2') & cell2mat(runGroupsParametersTable.holdingVoltage) == 0 & cell2mat(runGroupsParametersTable.nPulsesRed) == 1 & cell2mat(runGroupsParametersTable.amplitudeRed) == 5);
...
trace250 = selectedRunGroupsAnalysisTable.trace{42,1};
trace500 = selectedRunGroupsAnalysisTable.trace{49,1};  
trace2000 = selectedRunGroupsAnalysisTable.trace{56,1}; 
trace5000 = selectedRunGroupsAnalysisTable.trace{63,1}; 
trace10000 = selectedRunGroupsAnalysisTable.trace{69,1}; 
...
selectedRunGroups = find(strcmp(runGroupsParametersTable.activeChannels,'ao0, ao2') & cell2mat(runGroupsParametersTable.holdingVoltage) == 0 & cell2mat(runGroupsParametersTable.nPulsesRed) == 1 & cell2mat(runGroupsParametersTable.pulseWidthRed) == 5000);
selectedRunGroups = selectedRunGroups(selectedRunGroups~=15)
selectedRunGroups = selectedRunGroups(selectedRunGroups~=16)
selectedRunGroupsAnalysisTable = mouseSelectedCellsAnalysisTable(ismember(mouseSelectedCellsAnalysisTable.runGroup,selectedRunGroups),:);
...
trace5 = selectedRunGroupsAnalysisTable.trace{6,1};
trace3 = selectedRunGroupsAnalysisTable.trace{13,1};  
trace1 = selectedRunGroupsAnalysisTable.trace{20,1}; 
