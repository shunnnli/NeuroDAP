...
experimentName = 'Pitx_JAWS_Ephys_12';
...
selectedRunGroups = find(strcmp(runGroupsParametersTable.activeChannels,'ao0, ao2') & cell2mat(runGroupsParametersTable.holdingVoltage) == 0 & cell2mat(runGroupsParametersTable.nPulsesRed) == 1 & cell2mat(runGroupsParametersTable.amplitudeRed) == 5 & strcmp(runGroupsParametersTable.functionNameRed,'dmdOutputRect(1, 1, 1, 1, 2, 1)'));
...
trace250 = selectedRunGroupsAnalysisTable.trace{28,1};
trace500 = selectedRunGroupsAnalysisTable.trace{42,1};  
trace2000 = selectedRunGroupsAnalysisTable.trace{55,1}; 
trace5000 = selectedRunGroupsAnalysisTable.trace{68,1}; 
trace10000 = selectedRunGroupsAnalysisTable.trace{82,1}; 
...
selectedRunGroups = find(strcmp(runGroupsParametersTable.activeChannels,'ao0, ao2') & cell2mat(runGroupsParametersTable.holdingVoltage) == 0 & cell2mat(runGroupsParametersTable.nPulsesRed) == 1 & cell2mat(runGroupsParametersTable.pulseWidthRed) == 5000 & strcmp(runGroupsParametersTable.functionNameRed,'dmdOutputRect(1, 1, 1, 1, 2, 1)'));
selectedRunGroupsAnalysisTable = mouseSelectedCellsAnalysisTable(ismember(mouseSelectedCellsAnalysisTable.runGroup,selectedRunGroups),:);
...
trace5 = selectedRunGroupsAnalysisTable.trace{20,1};
trace3 = selectedRunGroupsAnalysisTable.trace{38,1};  
trace1 = selectedRunGroupsAnalysisTable.trace{51,1}; 
