...
experimentName = 'MLR_ZI_Ephys_3_1';
...
cat1_selectedCellsIDs = [1,3];
cat2_selectedCellsIDs = [2,4,5,6,7];
...
%% amplitude vs heightPulsePeak - connection strength - cell 3

cat1_queryOptoParameter =  'amplitudeBlue';
cat2_queryOptoParameter =  'amplitudeRed';
queryRunFeature = 'heightPulsePeak';

plotBaseName = [experimentName '_' 'connectionStrength' '_' 'comparisonBlueRed' '_' 'cell3' '_' queryRunFeature]; 
queryOptoParameterValuesOverall = [5];

cat1_selectedCellsIDs = [3];
cat2_selectedCellsIDs = [3];

cat1_desiredEpochs = [1:21];
cat2_desiredEpochs = [1:21];
...
%% amplitude vs areaPulse - connection strength - cell 3
...
plotBaseName = [experimentName '_' 'amplitude35BlueRed' '_' 'cell3' '_' queryRunFeature]; 
queryOptoParameterValuesOverall = [5];
