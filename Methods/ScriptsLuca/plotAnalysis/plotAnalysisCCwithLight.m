...
selectedRunGroups = find(strcmp(runGroupsParametersTable.activeChannels,'ao0, ao1') & cell2mat(runGroupsParametersTable.widthCurrentPulse) == 12000 & cell2mat(runGroupsParametersTable.amplitudeCurrentPulse) == 250 & cell2mat(runGroupsParametersTable.amplitudeLightPulse) == 0.5);%500
...
selectedRunGroups = find(strcmp(runGroupsParametersTable.activeChannels,'ao0, ao1') & cell2mat(runGroupsParametersTable.widthCurrentPulse) == 12000 & cell2mat(runGroupsParametersTable.amplitudeCurrentPulse) == 500 & cell2mat(runGroupsParametersTable.widthLightPulse) == 5000);
selectedRunGroupsAnalysisTable = mouseSelectedCellsAnalysisTable(ismember(mouseSelectedCellsAnalysisTable.runGroup,selectedRunGroups),:);
...
traceWithLight = selectedRunGroupsAnalysisTable.trace{29,1};
