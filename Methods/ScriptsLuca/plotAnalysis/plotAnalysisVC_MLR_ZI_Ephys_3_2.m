...
experimentName = 'MLR_ZI_Ephys_3_2';
...
cat1_selectedCellsIDs = [2,6];
cat2_selectedCellsIDs = [3,4,5,7,8];
...
%% amplitude vs heightPulsePeak - connection strength - cell 6

cat1_queryOptoParameter =  'amplitudeBlue';
cat2_queryOptoParameter =  'amplitudeRed';
queryRunFeature = 'heightPulsePeak';

plotBaseName = [experimentName '_' 'connectionStrength' '_' 'comparisonBlueRed' '_' 'cell6' '_' queryRunFeature]; 
queryOptoParameterValuesOverall = [5];
...
%% amplitude vs areaPulse - connection strength - cell 6
...
plotBaseName = [experimentName '_' 'amplitude35BlueRed' '_' 'cell6' '_' queryRunFeature]; 
queryOptoParameterValuesOverall = [5];
...
plotBaseName = [experimentName '_' 'noDrugCarbachol' '_' 'cell6' '_' queryRunFeature]; 
queryOptoParameterValuesOverall = [5];

cat1_selectedCellsIDs = [6];
cat2_selectedCellsIDs = [6];

cat1_desiredEpochs = [26:30];
cat2_desiredEpochs = [31:37];
