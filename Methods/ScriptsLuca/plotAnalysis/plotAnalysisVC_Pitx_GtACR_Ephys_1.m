...
experimentName = 'Pitx_GtACR_Ephys_1_VC';
...
selectedRunGroups = selectedRunGroups(selectedRunGroups~=28)
...
trace250 = selectedRunGroupsAnalysisTable.trace{7,1};
trace500 = selectedRunGroupsAnalysisTable.trace{9,1};  
trace2000 = selectedRunGroupsAnalysisTable.trace{11,1}; 
trace5000 = selectedRunGroupsAnalysisTable.trace{13,1}; 
...
trace5 = selectedRunGroupsAnalysisTable.trace{5,1};
trace3 = selectedRunGroupsAnalysisTable.trace{7,1};  
