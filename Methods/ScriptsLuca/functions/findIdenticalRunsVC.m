function analysisTable = findIdenticalRunsVC(analysisTable)
    ...
    for i = 1:size(analysisTable, 1)
        ...
        fieldsToNeglectCurrentStruct = {'delayPulseBlue', 'delayPulseRed', 'cellCoordinates'};
        ...
        for j = 1:i-1
            ...
            fieldsToNeglectPreviousStruct = {'delayPulseBlue', 'delayPulseRed', 'cellCoordinates'};
