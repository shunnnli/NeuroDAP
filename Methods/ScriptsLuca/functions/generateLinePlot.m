function generateLinePlot(plotData,options)
    ...
    for iCat = 1:nCat
        ...
        if options.groupByCell == 1
            ...
            meansToPlot(1,iCat) = meanCellsToPlot;
            ...
            if nCat == 1 || nDataPerRun == 1
                ...
                meansToPlot(1,iCat) = meanRunsToPlot;
    ...
    hold on
    plot([1:nCat],meansToPlot,'-','Color',options.plotColor.cat1,'LineWidth',2);
