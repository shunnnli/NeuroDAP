function generateLinePlotAPpulse(featuresStruct, queryOptoParameter, queryOptoParameterValues, queryRunFeature, selectedRunGroups, selectedCellsIDs, overallExperimentName, savePlotPath, savePlots)
    ...
    plotName = ['IntP' '_' overallExperimentName '_' queryRunFeature,'_vs_', queryOptoParameter '_line'];
