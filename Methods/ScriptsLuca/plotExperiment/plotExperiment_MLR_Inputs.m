...
overallExperimentName = 'MLR_Inputs';

mouseExperimentNames = {};
mouseExperimentNames{1} = 'MLR_SNr_Ephys_1';
mouseExperimentNames{2} = 'MLR_ZI_Ephys_1';
mouseExperimentNames{3} = 'MLR_ZI_Ephys_2';
mouseExperimentNames{4} = 'MLR_ZI_Ephys_3';
mouseExperimentNames{5} = 'MLR_ZI_Ephys_2_2';
mouseExperimentNames{6} = 'MLR_ZI_Ephys_2_3';
mouseExperimentNames{7} = 'MLR_ZI_Ephys_2_2';
mouseExperimentNames{8} = 'MLR_ZI_Ephys_3_1';
mouseExperimentNames{9} = 'MLR_ZI_Ephys_3_2';
