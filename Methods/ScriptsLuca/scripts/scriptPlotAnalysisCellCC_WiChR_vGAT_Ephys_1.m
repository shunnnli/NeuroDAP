...
cat1_selectedRunGroupsAnalysisTable = cat1_selectedRunGroupsAnalysisTable(2,:);
...
options.xEvent = 25000;

options.xLimits = [20000,30000];
...
cat1_selectedCellsIDs = 4;%1, 34 %68 for cell 4, 34 for cell 1
cat2_selectedCellsIDs = 4;

cat1_desiredEpochs = [];
cat2_desiredEpochs = [];

cat1_selectedRunGroups = [69];
cat2_selectedRunGroups = [69];%69
...
cat1_selectedRunGroups = [13];
cat2_selectedRunGroups = [64];
...
cat1_selectedRunGroups = [68];
cat2_selectedRunGroups = [69];
...
% cat3_selectedCellsIDs = 1;
% cat4_selectedCellsIDs = 1;
% cat5_selectedCellsIDs = 1;
% cat6_selectedCellsIDs = 1;
% cat7_selectedCellsIDs = 1;
% cat8_selectedCellsIDs = 1;
% cat9_selectedCellsIDs = 1;
% 
% cat1_desiredEpochs = [];
% cat2_desiredEpochs = [];
% cat3_desiredEpochs = [];
