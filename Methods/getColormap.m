% Adapted from: Timothy Olsen (2022). Centered colormap generator (https://www.mathworks.com/matlabcentral/fileexchange/70530-centered-colormap-generator), MATLAB Central File Exchange. Retrieved May 27, 2022.
% with slight modification

function colMap = getColormap(botCol,topCol,numCol,varargin)
    ...
    topCol  = p.Results.topCol ./ 255; % define function variable from inputs
    botCol  = p.Results.botCol ./ 255; % define function variable from inputs
    numCol  = p.Results.numCol;        % define function variable from inputs
    midCol  = p.Results.midCol ./ 255; % define function variable from inputs
    ...
    %%%% Final colormap (rescale to make it between 0 and 1)
