...
%% Single session analysis for optoPair
...
[sessionParams,canceled] = inputSessionParams(sessionList,...
                                ...
                                bluePulseFreq=2,bluePulseDuration=10,blueStimDuration=10,...
...
prepareSyncROIs(sessionList(isRTPP));

% Run each session
for s = 1:length(sessionList)
    close all;
    clearvars -except s sessionList errorSessionIdx analysisParams sessionParams taskList redStimPatternList blueStimPatternList isRTPP withPhotometryNI plotPhotometry reloadAll
