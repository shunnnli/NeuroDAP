...
//20240915
// Adapted to deliver EP and LHb stim similtaneously and pair with reward
// EP stim only --> tone only
// EP + LHb stim --> stim only
// EP + LHb + tone --> pair
...
// CHANGE BACK!!!
int PairProbRange[2] = {1,60};
int StimOnlyProbRange[2] = {61, 70};
int ToneOnlyProbRange[2] = {71, 100};
