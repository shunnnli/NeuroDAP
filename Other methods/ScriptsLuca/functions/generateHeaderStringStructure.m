...
%     pulseString_ao1 = 'pulseString_ao1';
%     pulseString_ao2 = 'pulseString_ao2';

%     if isfield(headerStringStructure.state.phys.internal.pulses, pulseString_ao1) && isfield(headerStringStructure.state.phys.internal.pulses, pulseString_ao2)
% 
%         headerStringStructure.dmdBlue = 'ON';
%         headerStringStructure.dmdRed = 'ON';
%         
%     elseif isfield(headerStringStructure.state.phys.internal.pulses, pulseString_ao1) && ~isfield(headerStringStructure.state.phys.internal.pulses, pulseString_ao2)
% 
%         headerStringStructure.dmdBlue = 'ON';
%         headerStringStructure.dmdRed = 'OFF';
%         
%     elseif isfield(headerStringStructure.state.phys.internal.pulses, pulseString_ao2) && ~isfield(headerStringStructure.state.phys.internal.pulses, pulseString_ao1)
%         
%         headerStringStructure.dmdBlue = 'OFF';
%         headerStringStructure.dmdRed = 'ON';
%         
