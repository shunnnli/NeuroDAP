...
overallExperimentName = 'ZI_Inputs';
...
mouseExperimentNames{5} = 'MLR_ZI_Ephys_1';
mouseExperimentNames{6} = 'MLR_ZI_Ephys_2';
mouseExperimentNames{7} = 'MLR_ZI_Ephys_3';
mouseExperimentNames{8} = 'MLR_ZI_Ephys_2_2';
mouseExperimentNames{9} = 'MLR_ZI_Ephys_2_3';
mouseExperimentNames{10} = 'MLR_ZI_Ephys_2_2';
mouseExperimentNames{11} = 'MLR_ZI_Ephys_3_1';
mouseExperimentNames{12} = 'MLR_ZI_Ephys_3_2';
mouseExperimentNames{13} = 'DCN_ZI_Ephys_4_1';
