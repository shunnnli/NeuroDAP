...
overallExperimentName = 'DCN_SNr_Inputs';

mouseExperimentNames = {};
mouseExperimentNames{1} = 'DCN_SNr_Ephys_1_1';
mouseExperimentNames{2} = 'DCN_SNr_Ephys_2_1';
mouseExperimentNames{3} = 'DCN_SNr_Ephys_2_2';
mouseExperimentNames{4} = 'DCN_SNr_Ephys_3_1';
mouseExperimentNames{5} = 'DCN_SNr_Ephys_3_2';
