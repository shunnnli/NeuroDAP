...
overallExperimentName = 'vGAT_Contra_vGAT_Search';

mouseNames = {};
mouseNames{1} = 'vGAT_IC_Ephys_30_3';
mouseNames{2} = 'vGAT_IC_Ephys_40_1';
mouseNames{3} = 'vGAT_IC_Ephys_50_1';
mouseNames{4} = 'vGAT_IC_Ephys_50_2';
