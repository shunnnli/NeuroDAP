...
experimentName = 'Kali_Pitx_Ephys_2_CC';
...
selectedRunGroups = find(strcmp(runGroupsParametersTable.activeChannels,'ao0, ao1') & cell2mat(runGroupsParametersTable.widthCurrentPulse) == 12000 & cell2mat(runGroupsParametersTable.amplitudeCurrentPulse) == 2000 & cell2mat(runGroupsParametersTable.amplitudeLightPulse) == 1);
...
controlRunGroups = find(strcmp(runGroupsParametersTable.activeChannels,'ao0') & cell2mat(runGroupsParametersTable.amplitudeCurrentPulse) == 2000 & cell2mat(runGroupsParametersTable.widthCurrentPulse) == 12000); %& cell2mat(runGroupsParametersTable.amplitudeCurrentPulse) == 250
controlRunGroupsAnalysisTable = mouseSelectedCellsAnalysisTable(ismember(mouseSelectedCellsAnalysisTable.runGroup,controlRunGroups),:);
...
traceWithLight = selectedRunGroupsAnalysisTable.trace{5,1};
