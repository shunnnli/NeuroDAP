...
experimentName = 'vGAT_JAWS_Ephys_6_VC';
...
%% pulseWidthRed vs heightControlPeak

queryOptoParameter =  'pulseWidthRed';
...
selectedRunGroups = find(strcmp(runGroupsParametersTable.activeChannels,'ao0, ao2') & cell2mat(runGroupsParametersTable.holdingVoltage) == 0 & cell2mat(runGroupsParametersTable.nPulsesRed) == 1 & strcmp(runGroupsParametersTable.functionNameRed,'dmdOutputRect(1, 1, 1, 1, 2, 1)') & cell2mat(runGroupsParametersTable.amplitudeRed) == 5);
...
%% pulseWidthRed vs heightPulsePeak
...
trace250 = preprocessSignalVC(selectedRunGroupsAnalysisTable.trace{1,1});
trace500 = preprocessSignalVC(selectedRunGroupsAnalysisTable.trace{4,1});  
trace2000 = preprocessSignalVC(selectedRunGroupsAnalysisTable.trace{7,1}); 
trace5000 = preprocessSignalVC(selectedRunGroupsAnalysisTable.trace{10,1}); 
trace10000 = preprocessSignalVC(selectedRunGroupsAnalysisTable.trace{13,1}); 

%% pulseWidthRed vs areaControl
...
%% amplitudeRed vs heightControlPeak
...
selectedRunGroups = find(strcmp(runGroupsParametersTable.activeChannels,'ao0, ao2') & cell2mat(runGroupsParametersTable.holdingVoltage) == 0 & cell2mat(runGroupsParametersTable.nPulsesRed) == 1 & strcmp(runGroupsParametersTable.functionNameRed,'dmdOutputRect(1, 1, 1, 1, 2, 1)') & cell2mat(runGroupsParametersTable.pulseWidthRed) == 5000);
selectedRunGroupsAnalysisTable = mouseSelectedCellsAnalysisTable(ismember(mouseSelectedCellsAnalysisTable.runGroup,selectedRunGroups),:);
...
trace3 = selectedRunGroupsAnalysisTable.trace{4,1};  
trace1 = selectedRunGroupsAnalysisTable.trace{6,1}; 

%% amplitudeRed vs areaControl
...
trace5 = preprocessSignalVC(selectedRunGroupsAnalysisTable.trace{1,1});
trace3 = preprocessSignalVC(selectedRunGroupsAnalysisTable.trace{4,1});  
trace1 = preprocessSignalVC(selectedRunGroupsAnalysisTable.trace{7,1}); 
