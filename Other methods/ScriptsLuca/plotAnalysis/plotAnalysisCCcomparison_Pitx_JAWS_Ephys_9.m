...
selectedRunGroups = find(strcmp(runGroupsParametersTable.activeChannels,'ao0, ao2') & cell2mat(runGroupsParametersTable.widthCurrentPulse) == 6000 & cell2mat(runGroupsParametersTable.delayLightPulse) == 19000 & cell2mat(runGroupsParametersTable.amplitudeLightPulse) == 1);
...
plot(xValues, meanQueryRunFeatureDataArray,'Color',[0 0.4470 0.7410],'LineWidth',2);
ploterrorbar = errorbar(xValues,meanQueryRunFeatureDataArray,stdQueryRunFeatureDataArray,'.','Color',[0.3 0.3 0.3],'LineWidth', 1.2, 'CapSize', 20);
...
%traceWithLight = selectedRunGroupsAnalysisTable.trace{27,1};
...
stdQueryRunFeatureDataArray = nanstd(queryRunFeatureDataArray,1);
xValues = linspace(1,numel(queryOptoParameterValues),numel(queryOptoParameterValues));
plot(xValues, meanQueryRunFeatureDataArray,'Color',[0.7 0.7 0.7],'LineWidth',2);
ploterrorbar = errorbar(xValues,meanQueryRunFeatureDataArray,stdQueryRunFeatureDataArray,'.','Color',[0.3 0.3 0.3],'LineWidth', 1.2, 'CapSize', 20);
ploterrorbar.Annotation.LegendInformation.IconDisplayStyle = 'off';
hold on;
...
hold on;
plot(traceNoLight,'Color',[0 0 0],'LineWidth',2)
