...
cat1_selectedCellsIDs = [1,2,3,4,8];
...
%% amplitudeBlue vs heightPulsePeak - ipsi 

cat1_queryOptoParameter =  'amplitudeBlue';
queryRunFeature = 'heightPulsePeak';

plotBaseName = [experimentName '_' 'amplitudeBlue' '_' 'ipsi' '_' queryRunFeature]; 
queryOptoParameterValuesOverall = [5];

cat1_selectedCellsIDs = [6,7];
...
%% amplitudeBlue vs areaPulse - ipsi 
...
%% amplitudeBlue vs heightPulsePeak - connection strength

cat1_queryOptoParameter =  'amplitudeBlue';
cat2_queryOptoParameter =  'amplitudeBlue';
queryRunFeature = 'heightPulsePeak';

plotBaseName = [experimentName '_' 'ipsiContra' '_' queryRunFeature]; 
queryOptoParameterValuesOverall = [5];

cat1_selectedCellsIDs = [6,7];
cat2_selectedCellsIDs = [1,2,3,4,8];
...
%% amplitudeBlue vs areaPulse - connection strength
...
%% amplitudeRed vs heightPulsePeak - ipsi

cat1_queryOptoParameter =  'amplitudeRed';
queryRunFeature = 'heightPulsePeak';

plotBaseName = [experimentName '_' 'amplitudeRed' '_' 'ipsi' '_' queryRunFeature]; 
queryOptoParameterValuesOverall = [5];
...
%% amplitudeRed vs areaPulse - ipsi
...
%% amplitude vs heightPulsePeak - comparisonBlueRed - ipsi cells

cat1_queryOptoParameter =  'amplitudeBlue';
cat2_queryOptoParameter =  'amplitudeRed';
queryRunFeature = 'heightPulsePeak';

plotBaseName = [experimentName '_' 'ipsiComparisonBlueRed' '_' queryRunFeature]; 
queryOptoParameterValuesOverall = [5];

cat1_selectedCellsIDs = [6,7];
cat2_selectedCellsIDs = [6,7];
