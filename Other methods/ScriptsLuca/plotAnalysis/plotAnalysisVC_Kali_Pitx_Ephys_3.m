...
experimentName = 'Kali_Pitx_Ephys_3';
...
selectedRunGroups = find(strcmp(runGroupsParametersTable.activeChannels,'ao0, ao1') & cell2mat(runGroupsParametersTable.holdingVoltage) == -70 & cell2mat(runGroupsParametersTable.nPulsesBlue) == 1 & cell2mat(runGroupsParametersTable.amplitudeBlue) == 5);
...
plotName = [experimentName '_' typeCC '_' queryOptoParameter,'_vs_', queryRunFeature, '_m70mV'];
...
trace250 = selectedRunGroupsAnalysisTable.trace{1,1};
trace500 = selectedRunGroupsAnalysisTable.trace{4,1};  
trace2000 = selectedRunGroupsAnalysisTable.trace{7,1}; 
trace5000 = selectedRunGroupsAnalysisTable.trace{19,1}; 
trace10000 = selectedRunGroupsAnalysisTable.trace{20,1}; 
...
selectedRunGroups = find(strcmp(runGroupsParametersTable.activeChannels,'ao0, ao1') & cell2mat(runGroupsParametersTable.holdingVoltage) == -70 & cell2mat(runGroupsParametersTable.nPulsesBlue) == 1 & cell2mat(runGroupsParametersTable.pulseWidthBlue) == 5000);
selectedRunGroupsAnalysisTable = mouseSelectedCellsAnalysisTable(ismember(mouseSelectedCellsAnalysisTable.runGroup,selectedRunGroups),:);
...
trace5 = selectedRunGroupsAnalysisTable.trace{10,1};
trace3 = selectedRunGroupsAnalysisTable.trace{11,1};  
trace1 = selectedRunGroupsAnalysisTable.trace{12,1}; 
...
plotName = [experimentName '_' typeCC '_' queryOptoParameter,'_vs_', queryRunFeature, '_70mV'];
plotFullPath = fullfile(savePlotPath, plotName);
saveas(gcf, plotFullPath, 'pdf');
saveas(gcf, plotFullPath, 'fig');
...
typeCC = 'comparision_widthLightPulse_traces_m70mV';
...
typeCC = 'comparision_amplitudeLightPulse_traces_m70mV';
...
selectedRunGroups = find(strcmp(runGroupsParametersTable.activeChannels,'ao0, ao1') & cell2mat(runGroupsParametersTable.holdingVoltage) == -50 & cell2mat(runGroupsParametersTable.nPulsesBlue) == 1 & cell2mat(runGroupsParametersTable.amplitudeBlue) == 5);
selectedRunGroupsAnalysisTable = mouseSelectedCellsAnalysisTable(ismember(mouseSelectedCellsAnalysisTable.runGroup,selectedRunGroups),:);
...
plotName = [experimentName '_' typeCC '_' queryOptoParameter,'_vs_', queryRunFeature, '_m50mV'];
plotFullPath = fullfile(savePlotPath, plotName);
saveas(gcf, plotFullPath, 'pdf');
saveas(gcf, plotFullPath, 'fig');
...
trace250 = selectedRunGroupsAnalysisTable.trace{1,1};
trace500 = selectedRunGroupsAnalysisTable.trace{6,1};  
trace2000 = selectedRunGroupsAnalysisTable.trace{11,1}; 
trace5000 = selectedRunGroupsAnalysisTable.trace{16,1}; 
trace10000 = selectedRunGroupsAnalysisTable.trace{21,1}; 
...
selectedRunGroups = find(strcmp(runGroupsParametersTable.activeChannels,'ao0, ao1') & cell2mat(runGroupsParametersTable.holdingVoltage) == -50 & cell2mat(runGroupsParametersTable.nPulsesBlue) == 1 & cell2mat(runGroupsParametersTable.pulseWidthBlue) == 5000);
selectedRunGroupsAnalysisTable = mouseSelectedCellsAnalysisTable(ismember(mouseSelectedCellsAnalysisTable.runGroup,selectedRunGroups),:);
...
trace5 = selectedRunGroupsAnalysisTable.trace{1,1};
trace3 = selectedRunGroupsAnalysisTable.trace{6,1};  
trace1 = selectedRunGroupsAnalysisTable.trace{11,1}; 
...
typeCC = 'comparision_widthLightPulse_traces_m50mV';
