...
experimentName = 'WiChR_Test_2_CC';
...
selectedRunGroups = find(strcmp(runGroupsParametersTable.activeChannels,'ao0, ao1') & cell2mat(runGroupsParametersTable.widthCurrentPulse) == 12000 & cell2mat(runGroupsParametersTable.amplitudeCurrentPulse) == 750 & cell2mat(runGroupsParametersTable.amplitudeLightPulse) == 5);
...
%% widthLightPulse vs areaVtPulse NEW
...
selectedRunGroups = find(strcmp(runGroupsParametersTable.activeChannels,'ao0, ao1') & cell2mat(runGroupsParametersTable.widthCurrentPulse) == 12000 & cell2mat(runGroupsParametersTable.widthLightPulse) == 1000 & cell2mat(runGroupsParametersTable.amplitudeLightPulse) == 5);
selectedRunGroupsAnalysisTable = mouseSelectedCellsAnalysisTable(ismember(mouseSelectedCellsAnalysisTable.runGroup,selectedRunGroups),:);

traceWithLight = selectedRunGroupsAnalysisTable.trace{4,1};
...
plotName = [experimentName '_' typeCC '_trace4'];
plotFullPath = fullfile(savePlotPath, plotName);
% saveas(gcf, plotFullPath, 'pdf');
% saveas(gcf, plotFullPath, 'fig');
