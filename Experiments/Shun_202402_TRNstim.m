...
%% Baseline iGABASnFR: plot water, airpuff, stim, tone
...
for s = 1:length(signalRange)
    ...
    saveFigures(gcf,'Summary_random_iGABASnFR',...
            strcat(resultspath),...
            saveFIG=true,savePDF=true);
end
...
colorList = {[.7 .7 .7],bluePurpleRed(500,:),bluePurpleRed(300,:)};
