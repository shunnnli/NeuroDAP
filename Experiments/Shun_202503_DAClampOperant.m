...
results_tone_al_unclamped = plotGroupedTrialStats(tone_al_unclamped,ylabels,groupSize=1,...
                            color=baselineColor,...
                            plot=true,plotNextTile=false);
results_tone_al_clamped = plotGroupedTrialStats(tone_al_clamped,ylabels,groupSize=1,...
                            color=pidColor,...
                            plot=true,plotNextTile=false);
